...
async function main() {
  ...
  await prisma.datePlan.upsert({
    ...
    create: {
      ...
      status: "draft",
      constraints: {
        budget: { total: 80000, currency: "KRW" },
        location: { city: "서울", district: "성수", maxTravelMinutes: 30 },
        dateTime: { preferredDate: "2026-08-01", durationHours: 3 },
        preferences: { mood: "조용한 대화" },
      },
      courses: [
        {
          courseId: "course-cafe-walk",
          label: "카페와 서울숲 산책",
          stops: [
            {
              order: 1,
              ...
              estimatedCost: 32000,
              estimatedMinutes: 50,
              rationale: "편안한 분위기에서 대화를 시작하기 좋아요.",
            },
            {
              order: 2,
              type: "walk",
              ...
              estimatedCost: 0,
              estimatedMinutes: 60,
              rationale: "산책하며 자연스럽게 대화를 이어갈 수 있어요.",
            },
          ],
