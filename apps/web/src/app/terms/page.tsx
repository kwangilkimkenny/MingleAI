...
export default function TermsPage() {
  return (
    <LegalPage title="서비스 이용약관">
      <LegalSection title="1. 서비스와 이용 자격">mingles는 로테이션 블라인드 데이트(음성·영상 대화), 채팅과 데이트 계획 기능을 제공하는 성인 대상 소개팅 서비스입니다. 본인확인을 완료한 만 19세 이상만 계정을 만들 수 있습니다.{"\n\n"}괴롭힘, 사칭, 불법 행위, 동의 없는 개인정보 공개와 상업적 권유에 서비스를 사용할 수 없습니다. 블라인드 데이트 중 통화를 녹화·녹음하거나 상대의 동의 없이 화면을 캡처·공유하는 행위를 금지합니다.</LegalSection>
      ...
      <LegalSection title="4. 계정 종료">앱 설정 맨 아래 회원탈퇴에서 언제든 탈퇴할 수 있습니다. 법령상 보관 의무가 있는 최소 정보를 제외한 계정 연결 데이터는 삭제 후 복구할 수 없습니다.</LegalSection>
    </LegalPage>
  );
}
